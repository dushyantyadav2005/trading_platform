    ...
    return ( 
        ...
        <div className='row'>
            ...
            <div className='col-6 p-5 mt-5'>
                ...
                <a href="a" className="" style={{textDecoration:"none"}}>Varsity <i class="fa-solid fa-arrow-right"></i></a>
                ...
                <a href="a" className="mb-3" style={{textDecoration:"none"}}>TradingQ&A <i class="fa-solid fa-arrow-right"></i></a>
            </div>
        </div>
    </div>
     );
